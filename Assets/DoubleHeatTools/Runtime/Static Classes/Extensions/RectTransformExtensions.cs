...
namespace DoubleHeat.Utilities {
    ...
    public static class RectTransformExtensions {
        ...
        public static float GetMaxWorldPositionYOfCorners (this RectTransform rectTrans) {
            Vector3[] corners = new Vector3[4];
            rectTrans.GetWorldCorners(corners);
        ...
        public static float GetMinWorldPositionYOfCorners (this RectTransform rectTrans) {
            Vector3[] corners = new Vector3[4];
            rectTrans.GetWorldCorners(corners);
